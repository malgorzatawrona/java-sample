...
public class test {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Book b3 = new Book("H","puszczy");

        System.out.println(lib.rentItemToUser(b3, l));
        System.out.println(lib.rentItemToUser(b, l));
        System.out.println(lib.rentItemToUser(b, l));
        System.out.println(lib.rentItemToUser(b, l));
        System.out.println(lib.rentItemToUser(b, l));
        System.out.println(lib.rentItemToUser(b, l));
        System.out.println(lib.rentItemToUser(b, l));
        System.out.println(lib.rentItemToUser(m1, l));
        System.out.println(lib.rentItemToUser(m1, l));
        System.out.println(lib.rentItemToUser(m1, l));
        System.out.println(lib.rentItemToUser(m1, l));
        System.out.println(lib.rentItemToUser(m1, l));
